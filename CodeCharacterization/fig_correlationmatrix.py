...
# ========================================
SNR = 5
region = "Pancreas_malignant"
file_path = rf'C:\TF_IVIM_OSIPI\TF2.4_IVIM-MRI_CodeCollection\test_output_SNR{str(SNR)}.csv'
...
output_path = rf'C:\TF_IVIM_OSIPI\TF2.4_IVIM-MRI_CodeCollection\CodeCharacterization\nobounds_noinitialguess\{region}\correlationmatrices_{region}_SNR{str(SNR)}.png'
