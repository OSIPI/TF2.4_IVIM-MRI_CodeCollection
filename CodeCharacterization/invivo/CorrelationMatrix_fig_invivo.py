...
for algo in all_algorithms:
    csv_path = os.path.join(base_dir, f'IVIM_brain_{algo}_bounds_initialguess.csv')
...
def plot_correlation_matrices_tissue(tissue_mask, tissue_name):
    ...
    # Save and show
    save_path = rf"C:\TF_IVIM_OSIPI\TF2.4_IVIM-MRI_CodeCollection\codecharacterization\invivo\CorrelationMatrix_{tissue_name.replace(' ', '')}_3params_bounds_initialguess.png"
