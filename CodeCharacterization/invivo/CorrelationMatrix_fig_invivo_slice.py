...
def plot_correlation_matrices_tissue(tissue_mask, tissue_name,slice_idx):
    ...
    # Save and show
    save_path = f"/home/rnga/dkuppens/TF2.4_IVIM-MRI_CodeCollection/CodeCharacterization/invivo/results/CorrelationMatrix_{anatomy}_{tissue_name}_{harmonization_string}_3params_clipped.png"
