...
base_dir = f"/home/rnga/dkuppens/TF2.4_IVIM-MRI_CodeCollection/CodeCharacterization/invivo/results/slice12/{harmonization_string}/"
results_dir = f"/home/rnga/dkuppens/TF2.4_IVIM-MRI_CodeCollection/CodeCharacterization/invivo/results/"
parameters = ['D', 'f', 'Dp']
...
def load_all_volumes(base_dir, algorithms, parameters):
    ...
    for algo in algorithms:
        ...
        for param in parameters:
            ...
            nii_path = os.path.join(base_dir, f"{harmonization_string}_{algo}_Brain_slice12_fit_{file_param}.nii")
...
def plot_3col_grid(volumes, slice_index=None, orientation='axial'):
    ...
    plt.savefig(os.path.join(results_dir, f"IVIM_ParameterMaps_3ColumnGrid_FixedScale_NaNsBlack_{harmonization_string}.png"), dpi=300)
    plt.show()
