...
if __name__ == "__main__":
    ...
    for anatomy in ["Brain"]:
        ...
        for name, requires_matlab, deep_learning in algorithmlist:
            run_algorithms(name, requires_matlab, deep_learning, data_norm, bval, valid_id, sx, sy, sz, anatomy, base_dir, nifti, harmonization_string, slice_idx, eng=eng, bounds=bounds, initial_guess=initial_guess)