...
def run_algorithms(algorithm_name, requires_matlab, deep_learning, data_norm, bval, valid_id, sx, sy, sz, anatomy, base_dir, nii,  slice_idx=None, eng=None, bounds=None, initial_guess=None):
...
if __name__ == "__main__":
    ...
    for anatomy in ["brain"]:
        ...
        if use_initial_guess:
            initial_guess = generic["Brain"].get("initial_guess", None)
        else:
            initial_guess = None

        if use_bounds:
            bounds = generic["Brain"].get("bounds", None)
        else:
            bounds = None
        ...
        for name, requires_matlab, deep_learning in algorithmlist:
            run_algorithms(name, requires_matlab, deep_learning, data_norm, bval, valid_id, sx, sy, sz, anatomy, base_dir, nifti, slice_idx, eng=eng, bounds=bounds, initial_guess=initial_guess)